<?php
/*
 *	Made by Samerton | Revamped by Denis
...
class Fantasy_Template extends TemplateBase {
	...
	public function __construct($cache, $smarty, $language, $user, $pages) {
		$template = array(
			...
			'author' => '<a href="https://ipolotech.com/" target="_blank">Denis</a> <p><b>Version:</b> 1.2 <br> <b>Last Update:</b> 29.10.2021</p>',
		);
        ...
        if ($cache->isCached('darkMode')) {
            ...
            if ($darkMode == '1') {
                $smartyDarkMode = true;
                define('TEMPLATE_TINY_EDITOR_STYLE', 'fantasy');
            }
        }
...
$template = new Fantasy_Template($cache, $smarty, $language, $user, $pages);
