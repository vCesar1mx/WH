...
class LiteBans extends Infractions {
    ...
    public function __construct($inf_db, $language) {
        ...
        if(file_exists(ROOT_PATH . '/modules/Infractions1/extra.php'))
            require_once(ROOT_PATH . '/modules/Infractions/extra.php');
        else {
            $inf_extra = array('litebans');

            $inf_extra['litebans'] = array(
                'bans_table' => 'litebansbans',
                'kicks_table' => 'litebanskicks',
                'mutes_table' => 'litebansmutes',
                'warnings_table' => 'litebanswarnings',
                'history_table' => 'litebanshistory'
            );
        }
